...
CLASSIFICATION_PROMPT = """You will be given {writing_type} written by a Chinese high school student, that they produced in response to {writing_prompt}.
    ...
    Statement: The student has depression or a low mood.
...
EVIDENCE_PROMPT = """You retrieved {writing_type} written by a Chinese high school student, that they produced in response to {writing_prompt}.
    ...
    You will later be asked to choose a score, representing how the student's level of depression or low mood compares to a typical Chinese high school student.

    Before even answering the question, consider whether the essay provides sufficient information to make a somewhat accurate judgment.

    Your output should JUST be the boolean True or False, for whether the essay provides sufficient information to make a somewhat accurate judgment.
...
results_df.to_csv('/Users/jw/Desktop/dt/jbs_work/Psychometrician_position/ivan proj/GPT_sentsOutputCompare_01022025.csv',
                  index=False)
