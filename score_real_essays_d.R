...
get_gpt_mark = function(essay) {
  content_in = paste0("Rate the statements S1 to S10 on a scale from 1 to 5, based on the extent to which they are evidenced in a high-school student's essay about the thing that makes them most sad.
...
#write.csv(rm, '/Users/jw/Desktop/dt/jbs_work/Psychometrician_position/ivan proj/git_repo/output/real_scores4mini_d.csv', row.names = F)
