...
# 3. remove v sparse terms (.95) ________________________________________________________________/  # MAYBE NOT
...
# 11. save the param.s of semi-fixed model ______________________________________________________/
# 12. test and item info _________________________________________________________________________/
